...
脚本会构建整个 workspace，复制示例 binary 和桌面工具，包括 `suzu-launcher`、`suzu-editor`、`suzu-xp3-viewer`，收录英文和中文用户文档、`templates/minimal-vn`、hello-world 和 short-demo 的 `.suzupack` 资源、JSON manifest，并生成 `dist/project-suzu-desktop.zip`。
...
workflow 上传的每个平台 archive 会包含工具、可视化剧本编辑器、benchmark CLI、示例、打包后的 hello-world 与 short-demo 资源、README、法律说明、品牌说明、第三方许可证声明、快速上手、框架指南、短篇 demo 计划、最小模板、XP3 接口文档和核心/开发文档。Release asset 文件名会包含 tag，例如 `project-suzu-v0.1.6-windows-x64.tar.gz`。

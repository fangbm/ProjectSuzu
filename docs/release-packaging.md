...
The script builds the workspace, copies example binaries, includes user documentation, packs hello-world assets into `.suzupack`, writes a JSON manifest, and creates `dist/project-suzu-desktop.zip`.

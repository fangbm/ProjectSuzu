...
[https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.5](https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.5)

按系统下载：

- Windows: `project-suzu-v0.1.5-windows-x64.tar.gz`
- Linux: `project-suzu-v0.1.5-linux-x64.tar.gz`

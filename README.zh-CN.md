...
[https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.6](https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.6)

按系统下载：

- Windows: `project-suzu-v0.1.6-windows-x64.tar.gz`
- Linux: `project-suzu-v0.1.6-linux-x64.tar.gz`

...
公开仓库只提供明文 XP3 读取和外部 XP3 插件接口。项目方可以为自己有权处理的资源包提供外部插件，但游戏专用处理器不放入本仓库。支持边界见：[docs/xp3-support.md](docs/xp3-support.md)。

## 下载使用

打开 GitHub Release：

[https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.3](https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.3)

按系统下载：

- Windows: `project-suzu-v0.1.3-windows-x64.tar.gz`
- macOS: `project-suzu-v0.1.3-macos-x64.tar.gz`
- Linux: `project-suzu-v0.1.3-linux-x64.tar.gz`
...
```powershell
cargo run -p suzu-launcher -- --krkr2suzu "D:\game" "D:\out" --xp3-plugin D:\plugins\xp3-plugin.json
```

...
公开仓库只提供明文 XP3 读取和外部 XP3 插件接口。项目方可以为自己有权处理的资源包提供外部插件，但游戏专用处理器不放入本仓库。支持边界见：[docs/xp3-support.md](docs/xp3-support.md) 和 [LEGAL.md](LEGAL.md)。

## 下载使用

打开 GitHub Release：

[https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.4](https://github.com/fangbm/ProjectSuzu/releases/tag/v0.1.4)

按系统下载：

- Windows: `project-suzu-v0.1.4-windows-x64.tar.gz`
- Linux: `project-suzu-v0.1.4-linux-x64.tar.gz`
